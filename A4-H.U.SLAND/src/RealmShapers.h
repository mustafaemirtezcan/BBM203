...
public:
    ...
    void inorder(int index, std::vector<std::string> &result);
    std::vector<std::string> preOrderTraversal(int index);
    void preorder(int index, std::vector<std::string> &result);
    std::vector<std::string> postOrderTraversal(int index);
    void postorder(int index, std::vector<std::string> &result);
